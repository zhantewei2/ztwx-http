...
var BaseHttpXhr = /** @class */ (function (_super) {
    ...
    BaseHttpXhr.prototype.send = function (method, url, params, headers, withCredentials, responseType) {
        ...
        return new Observable(function (subscriber) {
            ...
            _this.sendXhr(xhr, method, url, params, headers, withCredentials, responseType);
        });
    };
    BaseHttpXhr.prototype.sendXhr = function (xhr, method, url, params, headers, withCredentials, responseType) {
        var sendBody = "";
    ...
    BaseHttpXhr.prototype.setXhr = function (xhr) {
        this.xhr = xhr;
    };
    BaseHttpXhr.prototype.getResponseHeader = function (key) {
