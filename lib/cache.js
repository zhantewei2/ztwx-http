define(["require", "exports", "./store", "rxjs", "rxjs/operators"], function (require, exports, store_1, rxjs_1, operators_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var Cache = /** @class */ (function () {
        function Cache(http) {
            this.cacheExpireTag = "ztwx-http-cache-expire-tag";
            this.cacheDestroyDict = new store_1.Store();
            this.http = http;
        }
        Cache.prototype.cacheXhr = function (_a) {
            ...
            cacheDestroy.xhrLoad = new rxjs_1.Subject();
            return this.http.xhr(method, relativeUrl, params, params2).pipe(operators_1.tap(function (result) {
                var _a;
