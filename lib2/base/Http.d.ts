...
import { HttpCommonErrorType, HttpCommonError, HttpCommonErrorEvent } from "../types/http-base.type";
...
export declare type ErrorHandlerParams = BaseParams & HttpCommonError;
